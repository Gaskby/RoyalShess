/* RoyalShess HOJA DE CONFIGURACIÓN. ESTE ES EL ÚNICO ARCHIVO QUE NECESITAS TOCAR PARA AJUSTAR EL JUEGO. <<<. Cambia los números, guarda, y reinicia el servidor Ctrl+C y npm.cmd start.. Todo servidor y navegador lee de aquí, así que no hay valores repetidos. */
(function (root, factory) {
  ...
  const CONFIG = {
    ...
    server: {
      ...
      reconnectSeconds: 20,   // si se cae tu conexión, tienes este tiempo para volver
                                 // a la MISMA partida que queda en pausa mientras tanto
      msgPerSec: 25,   // tope de mensajes por segundo por conexión anti-inundación
    },
  };
